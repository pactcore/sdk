...
- Missing SDK coverage for implemented `core` routes: `8`.
...
- `POST /committee/validators`
- `GET /committee/validators`
- `GET /committee/validators/:id`
- `POST /committee/configure`
- `POST /committee/vote`
- `GET /committee/:missionId`
- `POST /committee/:missionId/finalize`
- `POST /committee/:missionId/appeal`
